    ...
    public partial class mig1 : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_FeatureSliders", x => x.Id);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_OfferDiscounts", x => x.Id);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ShippingAddress_CustomerIdId = table.Column<string>(type: "text", nullable: false),
                    ShippingAddress_Name = table.Column<string>(type: "text", nullable: false),
                    ShippingAddress_Surname = table.Column<string>(type: "text", nullable: false),
                    ...
                    ShippingAddress_Detail1 = table.Column<string>(type: "text", nullable: false),
                    ShippingAddress_Detail2 = table.Column<string>(type: "text", nullable: false),
                    ShippingAddress_Description = table.Column<string>(type: "text", nullable: false),
                    ...
                    ShippingAddress_CreatedDate = table.Column<DateTime>(type: "timestamp with time zone", nullable: false),
                    ShippingAddress_UpdatedDate = table.Column<DateTime>(type: "timestamp with time zone", nullable: false),
                    TotalAmount = table.Column<decimal>(type: "numeric", nullable: false),
                    CustomerIdId = table.Column<string>(type: "text", nullable: true),
                    CreatedDate = table.Column<DateTime>(type: "timestamp with time zone", nullable: false),
                    UpdatedDate = table.Column<DateTime>(type: "timestamp with time zone", nullable: false)
                },
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Orderings_AspNetUsers_CustomerIdId",
                        column: x => x.CustomerIdId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK_Orderings_AspNetUsers_ShippingAddress_CustomerIdId",
                        column: x => x.ShippingAddress_CustomerIdId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ProductImageUrl = table.Column<Guid>(type: "uuid", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    CargoCompanyId = table.Column<Guid>(type: "uuid", nullable: false),
                    CreatedDate = table.Column<DateTime>(type: "timestamp with time zone", nullable: false),
                    UpdatedDate = table.Column<DateTime>(type: "timestamp with time zone", nullable: false)
                },
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_CargoDetails_AspNetUsers_CustomerIdId",
                        column: x => x.CustomerIdId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id");
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_CargoDetails_Orderings_OrderingId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_UserComments_AspNetUsers_CustomerId",
                        column: x => x.CustomerId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_CargoDetails_CustomerIdId",
                table: "CargoDetails",
                column: "CustomerIdId");

            migrationBuilder.CreateIndex(
                name: "IX_CargoDetails_OrderingId",
                table: "CargoDetails",
                column: "OrderingId",
                unique: true);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Orderings_CustomerIdId",
                table: "Orderings",
                column: "CustomerIdId");

            migrationBuilder.CreateIndex(
                name: "IX_Orderings_ShippingAddress_CustomerIdId",
                table: "Orderings",
                column: "ShippingAddress_CustomerIdId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_UserComments_CustomerId",
                table: "UserComments",
                column: "CustomerId");
