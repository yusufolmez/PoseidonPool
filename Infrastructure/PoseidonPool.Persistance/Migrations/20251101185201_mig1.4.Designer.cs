...
namespace PoseidonPool.Persistance.Migrations
{
    ...
    [Migration("20251101185201_mig1.4")]
    partial class mig14
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("PoseidonPool.Domain.Entities.Catalog.ProductLike", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("PoseidonPool.Domain.Entities.Catalog.Category", b =>
                {
                    b.HasOne("PoseidonPool.Domain.Entities.Catalog.Category", "Parent")
                        .WithMany("Children")
